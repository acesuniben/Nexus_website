        ...
        <section className="w-full flex flex-col items-center text-center w-[90%]">
          <div className="relative px-5 md:px-0">
            <div className="hidden md:flex gap-1 md:gap-3 px-2 md:py-0 md:px-5 w-1/2 absolute left-[30%] top-[0%]">
              <div className="bg-[#166D86] text-white w-2/5 rounded-4xl px-4 py-2 md:px-10 md:py-4 text-xs md:text-xl font-bold whitespace-nowrap">
                <Link key="software" href="/software">
                  Software Club{" "}
                </Link>
              </div>
              <div className="text-[#166D86] border-2 w-2/5 border-[#166D86] bg-white rounded-4xl px-4 py-2 md:px-10 md:py-4 text-xs md:text-xl font-bold whitespace-nowrap">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg p-4 shadow-lg text-center">
                        ...
                        <div className="flex justify-center gap-3">
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://x.com/trouble__some">
                              <svg
                          ...
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://www.linkedin.com/in/jennifer-zack">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                          ...
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://www.instagram.com/ttrouble_some">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="none"
                                stroke="currentColor"
                  ...
                  <div className="bg-white rounded-2xl shadow-lg overflow-hidden h-full">
                    <div className="relative h-96 flex flex-col">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg p-4 shadow-lg text-center">
                        ...
                        <div className="flex justify-center gap-3">
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="http://x.com/@taiyeaisekhame">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                          ...
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://www.linkedin.com/in/taiye-aisekhame">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                          ...
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://www.instagram.com/taiyeaisekhame">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="none"
                                stroke="currentColor"
                    ...
                    <div className="relative h-96 flex flex-col">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg p-4 shadow-lg text-center">
                        ...
                        <div className="flex justify-center gap-3">
                          ...
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://www.instagram.com/manl.ikerico?igsh=dXIzajg3czN0bjJt">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="none"
                                stroke="currentColor"
                  ...
                  <div className="bg-white rounded-2xl shadow-lg overflow-hidden h-full">
                    <div className="relative h-96 flex flex-col">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg p-4 shadow-lg text-center">
                        ...
                        <div className="flex justify-center gap-3">
                          <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                            <a href="https://twitter.com/lade_177">
                              <svg
                                className="w-4 h-4 text-gray-600"
                                fill="currentColor"
                                viewBox="0 0 24 24"
