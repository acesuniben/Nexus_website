        ...
        <div className="">
            ...
            <section className="w-[90%] flex flex-col gap-10 md:gap-10 justify-between items-center">
                ...
                <div className="flex flex-col md:gap-15 text-center items-center w-[80%]">
                    <div className="flex flex-col w-[100%] md:flex-row items-center">
                        <div className="flex gap-4 flex-col md:w-1/5 items-center"><Image src="/step1.svg" width={266.67} height={284.67} alt=""/><p className="text-[#2F327D] font-semibold">Don’t know how to pay your ACES Dues? Follow the steps below to complete your payment successfully</p></div>
                        <div><Image src="/connector.svg" width={206.67} className="md:self-start rotate-90 md:rotate-0" height={206.67} alt=""/></div>
                        <div className="flex gap-4 flex-col md:w-1/5 items-center"><Image src="/step2.svg" width={266.67} height={284.67} alt=""/><p className="text-[#2F327D] font-semibold">Make your payment via bank transfer, mobile banking app, or direct deposit.</p></div>
                        <div><Image src="/connector.svg" width={206.67} className="md:self-start rotate-90 md:rotate-0" height={206.67} alt=""/></div>
                        <div className="flex gap-4 flex-col md:w-1/5 items-center"><Image src="/step3.svg" width={266.67} height={284.67} alt=""/><p className="text-[#2F327D] font-semibold">Present your payment receipt (bank alert or Cash) at the Secretariat</p></div>
                    </div>
                    <div className="flex flex-col md:flex-row md:justify-center items-center w-[100%]">
                        ...
                        <div className="flex gap-4 flex-col md:w-1/5 items-center"><Image src="/step4.svg" width={266.67} height={284.67} alt=""/><p className="text-[#2F327D] font-semibold">Wait while your payment is confirmed by any of the Departmental Executives.</p></div>
                        <div><Image src="/connector.svg" className="md:self-start rotate-90 md:rotate-0" width={206.67} height={206.67} alt=""/></div>
                        <div className="flex gap-4 flex-col md:w-1/5 items-center"><Image src="/step5.svg" width={266.67} height={284.67} alt=""/><p className="text-[#2F327D] font-semibold">Once confirmed, collect your official ACES Receipt as proof of payment.</p></div>
                    </div>
                </div>
            </section>
            ...
            <section className="w-[90%] md:w-[100%] flex flex-col gap-10 md:gap-15 justify-between items-center">
                ...
                <div className="w-[100%] md:w-[60%] flex flex-col gap-6 md:gap-10 shadow-xl p-10">
                    ...
                    <div className="flex justify-between"><p className="text-[#2F327D] md:text-xl font-semibold">Bank :</p><p className="text-[#0FACAC] md:text-xl font-semibold">Uniben Microfinance Bank</p></div>
                    <div className="flex justify-between"><p className="text-[#2F327D] md:text-xl font-semibold">Amount <span className="text-[#0FACAC]">(100L)</span>:</p><p className="text-[#0FACAC] md:text-xl font-semibold">N 2,000</p></div>
                    <div className="flex justify-between"><p className="text-[#2F327D] md:text-xl font-semibold">Amount <span className="text-[#0FACAC]">(200L - 500L)</span>:</p><p className="text-[#0FACAC] md:text-xl font-semibold">N 2,000</p></div>
                    <div className="flex justify-between"><p className="text-[#2F327D] md:text-xl font-semibold">Account Name :</p><p className="text-[#0FACAC] md:text-xl font-semibold">Computer Engineering <br/> Subscription Account</p></div>
                </div>
            </section>
            ...
            <section className="w-[90%] md:w-[90%] flex flex-col gap-10 md:gap-15 justify-between items-center">
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="text-[#696984]">Still confused? contact any of the details below for more clarity and for more information.</p>
                                ...
                                <div className="flex flex-col md:flex-row w-[100%] gap-5 md:gap-10 justify-center items-center">
