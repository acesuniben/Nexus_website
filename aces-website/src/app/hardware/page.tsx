...
export default function Software() {
  ...
  const governors = [
    ...
    },
    {
      ...
      role: "Deputy Governor",
      description:
        "300L Student of CPE. A growing tech lover with interest in electronics and Embedded Systems",
      picture: "/efeteyan.png",
      facebook: "#",
      github: "#",
      linkedIn: "#",
    },
  ...
  const activities = [
    {
      picture: "/research-icon.png",
      title: "Research",
      paragraph:
        "The club engage in different Classwork and assignment to research on different components and projects that develop them individually and also work and learn with each other.",
    },
    {
      picture: "/pcb-icon.png",
      title: "Building Projects",
      paragraph:
        "The club works on a lot of projects and also ensure that the members of the club participate so that they can be increase their knowlegde and skills in different areas.",
    },
    {
      picture: "/mentorship.svg",
      title: "Mentorships",
      paragraph:
        "The Governors mentor the members of the club and direct them on the way to go and also to ensure that they are consistent and improve individually",
    },
  ];
  return (
    <div className="">
      ...
      <main className="flex flex-col gap-16 md:gap-32 items-center mb-20">
        ...
        <section className="w-full md:w-2/3 text-center flex flex-col gap-3 mt-10 md:mt-20 px-4">
          <h1 className="text-2xl md:text-4xl text-[#2F327D] font-bold leading-tight">
            ...
            Students <span className="text-[#0FACAC]">Hardware Club</span>
          </h1>
          <p className="text-sm md:text-base text-gray-600">
            Making a difference and inspiring new wave of hardware engineers
          </p>
        </section>
        ...
        <section className="flex flex-col-reverse md:flex-row gap-5 md:gap-0 justify-between md:justify-evenly items-center px-4 w-full">
          <div className="flex flex-col gap-8 relative w-[100%] md:w-2/5 items-start justify-evenly">
            ...
            <p className="text-sm mt-3 md:text-base text-gray-600 leading-relaxed">
              ...
              <span className="text-[#0FACAC]">
                Emeritus President of Golden Age Executives 23/24 by Victor
                Warikobo-West
              </span>
              . They saw the importance of engaging the students of the
              department of Computer Engineering to ensure that they are have an
              area of interest and ensure that they are well grounded in
              whatever path they choose. The club is ran by the Appointed (Admin
        ...
        <section className="text-center flex flex-col items-center gap-10 md:gap-20 w-full px-4">
          <div className="w-full flex flex-col gap-3 md:gap-5 items-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2F327D]">
              ...
              <span className="text-[#0FACAC]">Niches</span>
            </h2>
            <p className="w-[90%] md:w-1/2 text-sm md:text-base text-gray-600">
              There are different areas in hardware that one can venture into.
              These are the ones the hardware club are working on. Choose what
              suits you best.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 w-full max-w-4xl">
            {niches.map((niche) => (
              <div
                key={niche.title}
                className="flex justify-between gap-2 bg-white rounded-2xl md:rounded-4xl shadow-xl p-6 md:p-10 w-full"
              >
                <div className="flex flex-col justify-center">
                  <h4 className="text-[#2F327D] text-lg md:text-xl text-left font-medium">
                    {niche.title} <br /> {niche.name}
                  </h4>
                </div>
                <div className="self-center flex-shrink-0">
                  <Image
                    src={niche.src}
                    alt={niche.title + " icon"}
                    width={80}
                    height={60}
                    className="md:w-[113.5px] md:h-[83.5px]"
                  />
                </div>
              </div>
            ))}
        ...
        <section className="flex flex-col md:flex-row items-center gap-6 md:gap-12 w-full max-w-6xl mx-auto px-4">
          <div className="w-full md:w-1/2 flex flex-col gap-4 md:gap-6">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2F327D]">
              Worried about{" "}
              <span className="text-[#0FACAC]">time and location?</span>
            </h2>
            <p className="text-sm md:text-base text-gray-600 leading-relaxed">
              Don't worry no need to panic and be worried about where the
              classes are held and the time these classes are held. The details
              are below.
            </p>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div className="flex-1">
                  <p className="text-[#2F327D] font-semibold text-sm md:text-base leading-tight">
                    400L CPE Class, Faculty of Engineering, University of Benin,
                    Ugbowo.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-row gap-6 md:gap-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#2F327D] font-medium text-sm md:text-base">
                    08024568653
                  </span>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 ">
              ...
              <div className="w-full md:w-1/2 space-y-4 md:space-y-6 text-center md:text-left">
                ...
                <p className="text-sm md:text-lg text-gray-600 leading-relaxed">
                  Communicate with like-minds. Associate with other people that
                  are willing to grow and to also make impact in the department
                  of Computer Engineering and the world at large. Join the Group
                  chat and enjoy all these benefits.
                </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
              ...
              <div className="w-full md:w-3/5 text-center md:text-left space-y-4 md:space-y-6">
                <h3 className="text-xl md:text-3xl font-bold text-[#2F327D]">
                  Learn More with the{" "}
                  <span className="text-[#0FACAC]">ACES Mobile App</span>
                </h3>
                <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                  Login to the mobile app and have access to more resources that
                  will help in your{" "}
                  <span className="text-[#0FACAC]">hardware</span> journey. It
                  is important so that grow in knowledge based on your niche.
                </p>
                <p className="text-sm md:text-base text-gray-600">
        ...
        <section className="py-12 md:py-20 px-4 md:px-8 lg:px-16">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2F327D] mb-2 md:mb-4">
              ACES Hardware Club{" "}
              <span className="text-[#0FACAC]">Governors</span>
            </h2>
            <p className="text-sm md:text-base text-gray-600 mb-8 md:mb-12 max-w-2xl mx-auto">
              These are the people that are in charge and also run the
            ...
            <div className="space-y-6 md:space-y-10 ">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-10 justify-center">
                {governors.slice(0, 2).map((governor) => (
                  <div
                    key={governor.name}
                    className="flex flex-col md:flex-row bg-white shadow-lg rounded-xl p-4 md:p-6 w-full max-w-lg mx-auto"
                  >
              ...
              <div className="flex justify-center">
                {governors.slice(2, 3).map((governor) => (
                  <div
                    key={governor.name}
                    className="flex flex-col md:flex-row bg-white shadow-lg rounded-xl p-4 md:p-6 w-full max-w-lg"
                  >
                    <div className="flex justify-center md:justify-start mb-4 md:mb-0 md:mr-4">
                      <Image
                        src={governor.picture}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
                These are the few activities that are done in the hardware club.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                <div className="p-4 md:p-6 text-center">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#2F327D] mb-2 md:mb-3">
                    PCB Design
                  </h3>
                  <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                    Learn how to design professional printed circuit boards
              ...
              <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                <div className="p-4 md:p-6 text-center">
                  ...
                  <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                    Master the art of soldering components and build your own
                    electronic circuits from scratch.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                <div className="p-4 md:p-6 text-center">
                  ...
                  <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                    Design and simulate electronic circuits for various
