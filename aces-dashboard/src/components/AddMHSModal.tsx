...
interface AddMHSModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (formData: MHSFormData) => void;
}
...
export default function AddMHSModal({
  isOpen,
  onClose,
  onSubmit,
}: AddMHSModalProps) {
  ...
  const handleInputChange = (field: keyof MHSFormData, value: string) => {
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Error submitting MHS:", error);
    } finally {
      setIsLoading(false);
    }
  };
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    placeholder="What is this MHS post about?"
                    rows={4}
                  ...
                  {imagePreview ? (
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Upload an image for your MHS post
                      </p>
                      <button
                        type="button"
                        onClick={() =>
                          document.getElementById("mhs-file-input")?.click()
                        }
