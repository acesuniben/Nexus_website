              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div className="group">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-4 focus:border-transparent transition-all duration-200 placeholder-gray-400"
                    style={
                      {
                ...
                <div className="group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none transition-all duration-200 placeholder-gray-400"
                    onFocus={(e) => {
                      e.target.style.borderColor = "#166D86";
                      e.target.style.boxShadow =
                        "0 0 0 4px rgba(22, 109, 134, 0.1)";
                ...
                <div className="group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-4 focus:ring-teal-100 focus:border-teal-500 transition-all duration-200 placeholder-gray-400"
