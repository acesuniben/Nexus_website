...
export default function TimetablePage() {
  ...
  const [currentSemesterForm, setCurrentSemesterForm] = useState({
    semester: "First",
    session: "2024/2025",
  });
    ...
    try {
      ...
      const response = await fetch(
        "https://aces-utky.onrender.com/api/admin/timetable/set-current-semester",
        {
          ...
          body: JSON.stringify({
            semester: currentSemesterForm.semester,
            session: currentSemesterForm.session,
          }),
        }
      );
      ...
      if (response.ok) {
        ...
        const semester =
          ...
          currentSemesterForm.semester;
        const session =
          result.session ||
          result.currentSession ||
          currentSemesterForm.session;

        alert(`Successfully set current semester to ${semester} ${session}`);
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={currentSemesterForm.semester}
                  onChange={(e) =>
                    setCurrentSemesterForm({
                      ...currentSemesterForm,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={currentSemesterForm.session}
                  onChange={(e) =>
                    setCurrentSemesterForm({
                      ...currentSemesterForm,
            ...
            <div className="flex space-x-3 mt-6">
              <button
                onClick={() => setShowSetSemesterModal(false)}
                disabled={isSettingSemester}
              ...
              >
                {isSettingSemester ? "Setting..." : "Set Semester"}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-white/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
            ...
            <div className="flex space-x-3">
              ...
              <button
                onClick={handleClearCurrentSemester}
                disabled={isClearing}
